  ...
  return (
    <div className='overflow-hidden'>
      ...
      <div className='mx-auto max-w-3xl px-4 py-16 flex flex-col gap-4 z-10 md:mt-[7rem] mt-[5rem] '>
        ...
        <p
        >We operate the mobile application Munii (the ' <b>App</b>'), as well as any other related  products and services that refer or link to these <b>legal terms</b> (the 'Legal Terms')  (collectively, the '<b>Services</b>').
        </p>
        <p>
          You can contact us by phone at <b>PHONE NUMBER</b>, email at <b>EMAIL</b>, or by mail  to ADDRESS, LAGOS.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether  personally or on behalf of an entity ('<b>you</b>'), and Munii, concerning your access to and  use of the Services. You agree that by accessing the Services, you have read,  understood, and agreed to be bound by all of these Legal Terms. <b>IF YOU DO NOT AGREE  WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM  USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</b>
        </p>
        <p>
          We will provide you with prior notice of any scheduled changes to the Services you are  using. Changes to Legal Terms will become effective seven (7) days after the notice is  given, except if the changes apply to security updates, in which case the changes will be  effective immediately. By continuing to use the Services after the effective date of any  changes, you agree to be bound by the modified terms. If you disagree with such  changes, you may terminate Services as per the section '<b><a href="/terms" className='border-b border-black'>TERM AND TERMINATION</a></b>'.
        </p>
        <p>
        ...
        <article>
          <h1 className='font-bold mb-4'>1. OUR SERVICES </h1>
          <p>
        ...
        <article className='text-justify flex flex-col gap-2'>
          <h1 className='font-bold mb-4'>2. INTELLECTUAL PROPERTY RIGHTS
          </h1>
          ...
          <div className='text-justify flex flex-col gap-2'>
            ...
            <ul className='list-disc'>
              ...
              <li>
                download or print a copy of any portion of the Content to which you have  properly gained access. </li>
            </ul>
            <p>
            ...
            <p>
              If you wish to make any use of the Services, Content, or Marks other than as set out in  this section or elsewhere in our Legal Terms, please address your request to: <b>EMAIL</b>. If  we ever grant you the permission to post, reproduce, or publicly display any part of our  Services or Content, you must identify us as the owners or licensors of the Services,  Content, or Marks and ensure that any copyright or proprietary notice appears or is  visible on posting, reproducing, or displaying our Content
            </p>
            <p>
          ...
          <div className='text-justify flex flex-col gap-2'>
            <h1 className='font-bold'>Your submissions
            </h1>
            <p>
        ...
        <article className='flex flex-col text-justify gap-2'>
          <h1 className='font-bold mb-2'>3. USER REPRESENTATIONS
          </h1>
          <p>
        ...
        <article className='flex flex-col text-justify gap-2'>
          ...
          <p>
            You agree to provide current, complete, and accurate purchase and account information  for all purchases made via the Services. You further agree to promptly update account  and payment information, including email address, payment method, and payment card  expiration date, so that we can complete your transactions and contact you as needed.  Sales tax will be added to the price of purchases as deemed required by us. We may  change prices at any time. All payments shall be in Naira. <br />
        ...
        <article className='flex flex-col text-justify gap-2'>
          ...
          <ul className='list-disc'>
            <li>
              Systematically retrieve data or other content from the Services to create or  compile, directly or indirectly, a collection, compilation, database, or directory  without written permission from us. </li>
            <li>
        ...
        <article className='flex flex-col text-justify gap-2'>
          ...
          <p>
            We do not assert any ownership over your Contributions. You retain full ownership of all  of your Contributions and any intellectual property rights or other proprietary rights  associated with your Contributions. We are not liable for any statements or  representations in your Contributions provided by you in any area on the Services. You  are solely responsible for your Contributions to the Services and you expressly agree to
        ...
        <article className='flex flex-col text-justify gap-2'>
          ...
          <div className='flex flex-col text-justify gap-2'>
            <h2 className='font-bold'>Use Licence
            </h2>
            <p>
            ...
            <ol className='list-decimal'>
              ...
              <li> remove, alter, or obscure any
                proprietary notice (including any notice of copyright or trademark) posted by us or the  licensors of the App</li>
              <li>use the App for any revenue-generating endeavour, commercial  enterprise, or other purpose for which it is not designed or intended;</li>
          ...
          <div className='flex flex-col text-justify gap-2'>
            <h2 className='font-bold'>Apple and Android Devices
            </h2>
            <p>
            ...
            <ol className='list-decimal'>
              <li> the licence granted  to you for our App is limited to a non-transferable licence to use the application on a  device that utilises the Apple iOS or Android operating systems, as applicable, and in  accordance with the usage rules set forth in the applicable App Distributor’s terms of  service; </li>
              ...
              <li>you represent and warrant  that:
                <ul className='list-decimal'>
                  <li>you are not located in a country that is subject to a Nigerian government  embargo, or that has been designated by the Nigerian government as a 'terrorist  supporting' country and</li>
                  <li> you are not listed on any Nigerian government list of  prohibited or restricted parties;</li>
                </ul>
              </li>
              ...
              <li>you  acknowledge and agree that the App Distributors are third-party beneficiaries of the  terms and conditions in this mobile application licence contained in these Legal Terms,  and that each App Distributor will have the right (and will be deemed to have accepted  the right) to enforce the terms and conditions in this mobile
                application licence contained in these Legal Terms against you as a third-party  beneficiary thereof.
              </li>
            </ol>
          </div>
        ...
        <article className='flex flex-col text-justify gap-2'>
          ...
          <p>
            These Legal Terms shall be governed by and defined following the laws  of Nigeria. Munii and yourself irrevocably consent that the courts of Nigeria shall have  exclusive jurisdiction to resolve any dispute which may arise in connection with these  Legal Terms.
          </p>
        </article>
        <article className='flex flex-col text-justify gap-2'>
          <h1 className='font-bold mb-2'>
        ...
        <article className='flex flex-col text-justify gap-2'>
          ...
          <p>
            ...
            CONNECTION WITH THE SERVICES AND YOUR USE THEREOF, INCLUDING, WITHOUT  LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A  PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR  REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SERVICES'  CONTENT OR THE CONTENT OF ANY WEBSITES OR MOBILE APPLICATIONS LINKED TO  THE SERVICES AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY
          </p>
          <ul className='list-decimal'>
        ...
        <article className='flex flex-col text-justify gap-2'>
          ...
          <p>
            Visiting the Services, sending us emails, and completing online forms constitute  electronic communications. You consent to receive electronic communications, and you  agree that all agreements, notices, disclosures, and other communications we provide  to you electronically, via email and on the Services, satisfy any legal requirement that  such communication be in writing. YOU HEREBY AGREE TO THE USE OF ELECTRONIC  SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO ELECTRONIC  DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR  COMPLETED BY US OR VIA THE SERVICES. You hereby waive any rights or requirements  under any statutes, regulations, rules, ordinances, or other laws in any jurisdiction which
