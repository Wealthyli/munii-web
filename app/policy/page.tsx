      ...
      <div className='mx-auto max-w-3xl px-4 py-16 flex flex-col gap-4 z-10 md:mt-[7rem] mt-[5rem]'>
        <article >
          ...
          <div className='mb-6'>
            ...
            <p>
              Device Information : IP address, browser type, operating system, and device type.<br />
        ...
        <article >
          ...
          <div className='mb-6'>
            ...
            <p>
              Providing and Maintaining Services : To deliver, maintain, and improve our services and features
              <br />
              Account Management : To manage your account, including processing transactions and providing customer support.<br />
              Personalization: To tailor our services to your preferences and financial profile.
              <br />
              Communication : To contact you with updates, newsletters, marketing or promotional materials, and other information that may be of interest to you.
              <br />
              Security : To monitor and enhance the security of our services and protect against fraud.
              <br />
        ...
        <article >
          ...
          <div className='mb-6'>
            ...
            <p>
              ...
              <br />
              Business Transfers : In the event of a merger, acquisition, or sale of all or a portion of our assets, your personal information may be transferred as part of that transaction.<br />
        ...
        <article >
          ...
          <div className='mb-6'>
            ...
            <p>
              Encryption: Using SSL/TLS encryption to protect data transmitted over the internet.
        ...
        <article >
          ...
          <div className='mb-6'>
            ...
            <p>
              Access: The right to access the personal information we hold about you. <br />
              Correction: The right to request correction of inaccurate or incomplete information. <br />
              Deletion: The right to request the deletion of your personal information. <br />
              Restriction: The right to request the restriction of processing your personal information. <br />
              Objection: The right to object to the processing of your personal information.  <br />
              Portability: The right to request the transfer of your personal information to another entity. <br />
        ...
        <article >
          ...
          <div className='mb-6'>
            ...
            <p className=' mb-2 '>
              Email: support@munii.finance <br />
