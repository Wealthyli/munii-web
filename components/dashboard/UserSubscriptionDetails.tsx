...
const UserSubscriptionDetail: SubscriptionDetail[] = [
  {
    ...
    status: "Active",
    avatar:
      "https://media.dev.to/cdn-cgi/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fwhh1lpihw7h587pb2iuc.png",
    customer: "John Doe",
    plan: "Basic",
    revenue: "N10,000",
  },
  ...
  return (
    <div className="flex flex-col items-start justify-center gap-[29px] w-full">
      ...
      <div className="w-full border border-dark-gray shadow-2xl rounded-3xl flex flex-col items-start p-2">
        <h2 className="text-[20px] text-lgrey/01 pl-[21px] py-2">{selected}</h2>
