...
const NewsLetter = () => {
    return (
        <section
            className="relative top-[10rem] lg:top-[13rem] w-[100%] rounded-[30px] p-12 flex flex-col items-start justify-center text-white gap-8 text-lg"
            style={{
                background:
        ...
        >
            ...
            <div className='flex flex-row flex-wrap gap-8 '>
                ...
                />
                <CustomButton
                    overrideStyle="bg-black text-primary text-lg font-semibold w-[284px] rounded-2xl p-4"
                >
                    Submit
                </CustomButton>
            </div>
